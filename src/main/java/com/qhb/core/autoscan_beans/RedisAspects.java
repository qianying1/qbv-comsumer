package com.qhb.core.autoscan_beans;

import com.qhb.core.redis.RedisUtil;
import com.qhb.core.util.RedisServiceOpen;
...
public class RedisAspects {
    ...
    */
    ...
    /*@Pointcut("execution(* com.qhb.core.redis.RedisUtil.*(..))")
     ...
     * 通过连接点切入
     */
    @Before("execution(* com.qhb.core.redis.RedisUtil.set*(..))")
